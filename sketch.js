...
function draw() {
  ...
  if(gameState == "serve"){
    ...
    textSize(65);
    fill("black")
    text("Click anywhere to start" , 100 , windowHeight - 300)
    text("1) Use the submarine to catch waste." ,100 , windowHeight - 225);
    text("2) Stay away from the fishes." ,  100 , windowHeight  - 150);
